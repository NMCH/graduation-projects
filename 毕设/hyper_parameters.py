...
tf.app.flags.DEFINE_integer('datasets_num','10','''the database you choose,cifar10 or cifar100''')
tf.app.flags.DEFINE_string('loss_name','focalLoss','''the loss function you choose''')
...
train_dir = 'logs_' + FLAGS.version + '_cifar'+str(FLAGS.datasets_num) + '_' + FLAGS.loss_name + '/'
